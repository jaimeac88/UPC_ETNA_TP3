...
{
    public partial class frmUpComprobante :  DevExpress.XtraEditors.XtraForm
    {

        public EmpleadosBE emp = new EmpleadosBE();

        public FacturaBE ped = new FacturaBE();

        FacturaBL pdl = new FacturaBL();
       ...
       AlmacenBL albl = new AlmacenBL();
        ...
        public frmUpComprobante()
        {
            InitializeComponent();
        }

        public frmUpComprobante(int strcodigo)
        {
            //emp = be;
            InitializeComponent();
           ...
           // txtCodVendedor.Text = be.Id.ToString();
            ...
            ped = pdl.getFactura(strcodigo);


            cli = clibl.getcliente(ped.ClienteId);

            txtCodCliente.Text = cli.IdCliente.ToString();
            txtNombreCliente.Text = cli.Nombre.ToString();
            txtDocIdentidad.Text = cli.DocIdentidad.ToString();
            ...
            if (ped.TipoCP == 1)
            {
                txtComproba.Text = "Boleta de Venta";
            }
            else{

                txtComproba.Text = "Factura de Venta";
            }
        ...
        private void frmUpComprobante_Load(object sender, EventArgs e)
        {
     ...
     //        new frmConsultarDireccione(this).ShowDialog();
        ...
        private void Button25_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                if (dtgDetalleProd.Rows.Count > 1)
                {
                    ...
                    if (pdl.deldetallefactura(codigopedidodetpedido))
                    {
                        ...
                        for (int i = dtdetalle.Rows.Count - 1; i >= 0; i--)
                        {
                            ...
                            int coddetallepedidodtdetalle = int.Parse(dr["FacturaDetalleId"].ToString());
                    ...
                    else if (dtgDetalleProd.Rows.Count <= 1)

                    {
                        MessageBox.Show("El comprobante de venta por lo menos debe tener un Detalle de Asignado");}
        ...
        private void Button8_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                Boolean valor = pbl.uptpedido(ped.FacturaId, cocli, fecemision, fecentrega);
        ...
        public void actualizarDetalle(){
            ...
            dtdetalle = pdl.getdetalleFacturas(ped.FacturaId);
